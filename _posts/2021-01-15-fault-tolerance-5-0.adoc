...
This support is based on the https://github.com/smallrye/smallrye-reactive-utils/tree/master/reactive-converters[SmallRye Reactive Converters] project, so you have to make sure that the corresponding converter library is present.
